...
contract('ChainList', function(accounts){
    ...
    var buyerBalanceBefoteBuy, buyerBalanceAfterBuy;
    ...
    it("should buy an article", function() {
        return ChainList.deployed().then(function(instance) {
            ...
            buyerBalanceBefoteBuy = web3.fromWei(web3.eth.getBalance(buyer), "ether").toNumber();
            ...
            assert(buyerBalanceAfterBuy <= buyerBalanceBefoteBuy - articlePrice, "buyer should have spent " + articlePrice + " ETH");
